...
export type FluentMessageId =
  ...
  | 'service-codex'
  | 'service-codex-dialog-customModel'
  | 'service-codex-dialog-executablePath'
  | 'service-codex-dialog-instructions'
  | 'service-codex-dialog-model'
  | 'service-codex-dialog-reasoningEffort'
  | 'service-codex-dialog-timeoutSeconds'
  | 'service-codex-executable-placeholder'
  | 'service-codex-instructions-placeholder'
  | 'service-codex-model-balanced'
  | 'service-codex-model-custom'
  | 'service-codex-model-fast'
  | 'service-codex-model-light'
  | 'service-codex-model-quality'
  | 'service-codex-reasoning-high'
  | 'service-codex-reasoning-low'
  | 'service-codex-reasoning-medium'
  | 'service-codex-reasoning-none'
  | 'service-codex-reasoning-xhigh'
  | 'service-codex-validation-customModel'
  | 'service-codex-validation-timeout'
  | 'service-collinsdict'
  | 'service-customgpt1'
  | 'service-customgpt2'
  | 'service-customgpt3'
