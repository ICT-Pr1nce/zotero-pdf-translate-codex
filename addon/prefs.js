...
pref("__prefsPrefix__.codex.model", "gpt-5.4-mini");
pref("__prefsPrefix__.codex.customModel", "");
pref("__prefsPrefix__.codex.reasoningEffort", "none");
pref("__prefsPrefix__.codex.timeoutSeconds", 180);
pref("__prefsPrefix__.codex.executablePath", "");
pref("__prefsPrefix__.codex.instructions", "");
