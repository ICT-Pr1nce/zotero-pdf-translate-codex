...
service-codex=Codex (ChatGPT Login)
service-codex-dialog-model=Model preset
service-codex-dialog-customModel=Custom model (used only with Custom)
service-codex-dialog-reasoningEffort=Reasoning effort
service-codex-dialog-timeoutSeconds=Timeout (seconds)
service-codex-dialog-executablePath=Codex executable
service-codex-dialog-instructions=Additional translation requirements
service-codex-model-fast=GPT-5.4 mini — Fast (recommended)
service-codex-model-quality=GPT-5.6 Sol — High quality
service-codex-model-balanced=GPT-5.6 Terra — Balanced
service-codex-model-light=GPT-5.6 Luna — Lightweight
service-codex-model-custom=Custom model
service-codex-reasoning-none=None — Fastest (recommended)
service-codex-reasoning-low=Low
service-codex-reasoning-medium=Medium
service-codex-reasoning-high=High
service-codex-reasoning-xhigh=Extra high
service-codex-executable-placeholder=Leave empty to find the official standalone Codex automatically
service-codex-instructions-placeholder=Example: Prefer standard terminology from computer architecture.
service-codex-validation-timeout=Timeout must be a number between 10 and 600 seconds.
service-codex-validation-customModel=A custom model name is required when Custom is selected.
...
pref-title=Translate (Codex Enhanced)
