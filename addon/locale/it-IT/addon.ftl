...
service-codex=Codex (accesso ChatGPT)
service-codex-dialog-model=Modello predefinito
service-codex-dialog-customModel=Modello personalizzato (usato solo con Personalizzato)
service-codex-dialog-reasoningEffort=Livello di ragionamento
service-codex-dialog-timeoutSeconds=Timeout (secondi)
service-codex-dialog-executablePath=Eseguibile Codex
service-codex-dialog-instructions=Requisiti di traduzione aggiuntivi
service-codex-model-fast=GPT-5.4 mini — Veloce (consigliato)
service-codex-model-quality=GPT-5.6 Sol — Alta qualità
service-codex-model-balanced=GPT-5.6 Terra — Bilanciato
service-codex-model-light=GPT-5.6 Luna — Leggero
service-codex-model-custom=Modello personalizzato
service-codex-reasoning-none=Nessuno — Più veloce (consigliato)
service-codex-reasoning-low=Basso
service-codex-reasoning-medium=Medio
service-codex-reasoning-high=Alto
service-codex-reasoning-xhigh=Molto alto
service-codex-executable-placeholder=Lascia vuoto per trovare automaticamente Codex standalone
service-codex-instructions-placeholder=Esempio: preferire la terminologia standard dell'architettura dei calcolatori.
service-codex-validation-timeout=Il timeout deve essere compreso tra 10 e 600 secondi.
service-codex-validation-customModel=Il nome del modello è obbligatorio quando si seleziona Personalizzato.
...
pref-title=Traduci (Codex avanzato)
